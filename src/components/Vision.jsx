...
export default Vision;
        ...
        {/* <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-[40px]">

          <div className="col-span-1 md:col-span-2 lg:col-span-3 xl:col-span-3 bg-black/40 backdrop-blur-md rounded-2xl p-10 flex flex-col justify-between min-h-[420px] shadow-[0_0_40px_rgba(0,0,0,0.6)]">
            ...
            <div className="space-y-6">
              ...
              <div className="relative rounded-xl overflow-hidden">
                ...
                <div className="w-[127px] h-[48px] absolute flex items-center justify-between bg-blue-900 rounded-sm">
                  <span className="w-3 h-3 bg-white/70" />
                  <span className="gap-7 text-[15px] rounded-md tracking-wide">
                    OPEN TO ALL
                  </span>
                </div>
